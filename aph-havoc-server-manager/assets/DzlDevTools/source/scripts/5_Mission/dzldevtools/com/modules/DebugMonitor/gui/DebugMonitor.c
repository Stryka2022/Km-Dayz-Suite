/*
	Ported from COM core/modules/DebugMonitor/gui/DebugMonitor.c.
...
class ArkDebugMonitor
{
	...
	{
		m_WidgetRoot = GetGame().GetWorkspace().CreateWidgets("DzlDevTools/gui/DebugMonitor/layouts/day_z_debug_monitor.layout");
