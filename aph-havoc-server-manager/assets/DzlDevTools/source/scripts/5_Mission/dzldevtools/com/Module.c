/*
	Ported from DayZCommunityOfflineMode core/Module.c (unchanged).
	Base class for COM modules. Extend for separate objects; override mouse/key
	functions for extra utility.
*/
class Module
{
