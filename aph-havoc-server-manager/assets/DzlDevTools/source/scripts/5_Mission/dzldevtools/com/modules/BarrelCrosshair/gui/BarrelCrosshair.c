/*
	Ported from COM core/modules/BarrelCrosshair/gui/BarrelCrosshair.c (unchanged).
	Not registered as a Module (it wasn't in COM either); this is a
	ScriptedWidgetEventHandler bound by its layout. Toggled via COM_bc_Visible.
*/
