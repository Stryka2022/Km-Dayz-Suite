/*
	Ported from COM core/modules/ComEditor/gui/GameMenu.c.
	PORT CHANGE: checkboxLayout path rewritten to the packed mod path.
*/
class GameMenu extends PopupMenu
{
	...
	string checkboxLayout = "DzlDevTools/gui/ComEditor/layouts/CheckboxTemplate.layout";
