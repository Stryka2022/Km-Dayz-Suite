// Ported from COM core/modules/ComEditor/gui/WeatherMenu.c (unchanged).
// PluginSceneManager is vanilla (P:\scripts\4_world\plugins\pluginbase\pluginscenemanager.c).
