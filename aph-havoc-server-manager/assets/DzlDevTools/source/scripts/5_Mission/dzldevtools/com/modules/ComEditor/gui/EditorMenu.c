/*
	Ported from COM core/modules/ComEditor/gui/EditorMenu.c.
	PORT CHANGES: every CreateWidgets() path rewritten from mission-relative
	"$CurrentDir:missions\...\core\modules\<M>\gui\layouts\X.layout" to the mod's
	packed path "DzlDevTools/gui/<M>/layouts/X.layout". The layout assets were copied
	into DzlDevTools/gui/ mirroring COM's module substructure.
*/
class EditorMenu extends UIScriptedMenu
{
    ...
    {
        layoutRoot = GetGame().GetWorkspace().CreateWidgets( "DzlDevTools/gui/ComEditor/layouts/EditorMenu.layout" );
		...
		// object menu
		m_objectMenu   = GetGame().GetWorkspace().CreateWidgets( "DzlDevTools/gui/ComEditor/layouts/ObjectMenu.layout", layoutRoot );
		m_weatherMenu  = GetGame().GetWorkspace().CreateWidgets( "DzlDevTools/gui/ComEditor/layouts/WeatherMenu.layout", layoutRoot );
		m_positionMenu = GetGame().GetWorkspace().CreateWidgets( "DzlDevTools/gui/AdminTool/layouts/PositionMenu.layout", layoutRoot );
		m_gameMenu 	   = GetGame().GetWorkspace().CreateWidgets( "DzlDevTools/gui/ComEditor/layouts/GameMenu.layout", layoutRoot );
		m_objectInfoMenu = GetGame().GetWorkspace().CreateWidgets( "DzlDevTools/gui/ComEditor/layouts/ObjectEditorInfo.layout", layoutRoot );
		m_cameraMenu = GetGame().GetWorkspace().CreateWidgets( "DzlDevTools/gui/CameraTool/layouts/CameraSettings.layout", layoutRoot );
