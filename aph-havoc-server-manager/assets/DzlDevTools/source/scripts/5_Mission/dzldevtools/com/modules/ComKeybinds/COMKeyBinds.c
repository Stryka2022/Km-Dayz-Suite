/*
	Ported from COM core/modules/ComKeybinds/COMKeyBinds.c.
	HideHud() uses COM_GetClientMission().GetHud() -> now returns MissionGameplay
	(see StaticFunctions.c). IngameHud.GetHudPanelWidget() verified at
	P:\scripts\5_mission\gui\ingamehud.c:1023.
	FreeDebugCamera.GetInstance() verified at P:\scripts\3_game\entities\camera.c:90.
*/
